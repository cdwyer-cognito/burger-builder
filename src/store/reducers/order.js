...
const reducer = ( state = initialState, action ) => {
    ...
    switch ( action.type ) {
        ...
        case actionTypes.PURCAHSE_BURGER_FAIL: return updateObject( state, { loading: false });
        case actionTypes.PURCHASE_BURGER_START: return updateObject( state, { loading: true });
        case actionTypes.PURCHASE_INIT: return updateObject( state, { purchased: true });
        case actionTypes.FETCH_ORDERS_START: return updateObject( state, { loading: false });
